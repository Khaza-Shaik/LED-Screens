...
const TARGET_LOCATIONS = [
  { name: 'Benz Circle, Vijayawada', price: 120, impressions: 50000, city: 'Vijayawada' },
  { name: 'MG Road, Vijayawada', price: 95, impressions: 35000, city: 'Vijayawada' },
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div>
                            ...
                            <div className="flex items-center gap-4 text-xs font-medium text-slate-500">
                              <span>{(loc.impressions / 1000).toFixed(0)}K est. daily reach</span>
                              <span className="text-slate-300">|</span>
                              <span>₹{loc.price}/hr</span>
                            </div>
                          </div>
            ...
            <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
              <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                ...
                <div className="px-7 py-5 border-t border-slate-100 flex items-center justify-between bg-slate-50/50">
                  ...
                  <button className="inline-flex items-center gap-2 px-7 py-3 bg-indigo-600 text-white text-sm font-bold rounded-lg hover:bg-indigo-700 transition-all shadow-sm hover:shadow-md">
                    <CreditCard size={15} /> Pay ₹{totalCost.toLocaleString()}
                  </button>
                </div>
              </div>
